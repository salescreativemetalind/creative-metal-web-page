...
const SCHEMA = JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"Hastelloy C22 Pipe Supplier India","item":"https://www.creativemetalind.com/hastelloy-c22-pipe-supplier-india"}]}]});
...
export default function HasteloyC22PipeSupplierIndia() {
  return (
    <>
      ...
      <Meta name="description" content="Hastelloy C22 pipe supplier India — ASTM B622 N06022 seamless pipes. Universal corrosion resistant — oxidizing & reducing acids. FGD, pharma, chemical." />
