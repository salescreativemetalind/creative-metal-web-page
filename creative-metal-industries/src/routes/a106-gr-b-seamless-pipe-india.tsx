...
export default function A106GrBSeamlessPipeIndia() {
  return (
    <>
      ...
      <Meta name="description" content="A106 Gr.B seamless pipe supplier India — ASTM A106 Grade B carbon steel pipe for high-temperature service, power plants and refineries." />
      ...
      <main style={{"max-width":"960px",margin:"0 auto",padding:"3rem 1.5rem"}}>
        <div style={{"margin-bottom":"2.5rem","text-align":"center"}}>
          ...
          <p style={{"font-size":"1.05rem",color:"#374151","line-height":"1.8","max-width":"750px",margin:"0 auto"}}>
            Creative Metal Industries is a leading <strong>ASTM A106 Grade B seamless pipe supplier in India</strong> with 500+ tonnes ready stock for high-temperature service in power plants, refineries and process industries. As a specialist carbon steel seamless pipe supplier, we stock A106 Gr.B — the industry standard carbon steel seamless pipe for service up to 425°C, used for boiler feedwater, steam distribution, process piping and heat exchanger connections. All pipes supplied with Mill Test Certificate per EN 10204 3.1. <strong>IBR Form III-C</strong> available for boiler-connected piping. As a dependable <strong>ASTM A106 pipe</strong> and <strong>A106 seamless pipe supplier</strong>, we keep ready stock 1/2" to 24", SCH 40 to XXS at Vadodara — buy A106 pipe from a single A106 pipe supplier with full traceability.
          </p>
        </div>
