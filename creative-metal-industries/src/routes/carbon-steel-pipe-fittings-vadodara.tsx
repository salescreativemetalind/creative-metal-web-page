...
const SCHEMA = JSON.stringify({
  ...
  "@graph": [
    {
      "@type":"LocalBusiness","@id":"https://www.creativemetalind.com/carbon-steel-pipe-fittings-vadodara#business","parentOrganization":{"@id":"https://www.creativemetalind.com/#organization"},"name": "Creative Metal Industries",
...
export default function CarbonSteelPipeFittingsVadodara() {
  return (
    <>
      ...
      <Meta name="description" content="Carbon steel pipe supplier Vadodara — ASTM A106 Gr.B seamless pipe, ERW pipe IS 1239, CS buttweld fittings A234 WPB, carbon steel flanges A105." />
