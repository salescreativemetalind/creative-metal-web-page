 ...
 * Target: MS angle supplier Vadodara, MS channel ISMC supplier Gujarat
 */
import { Title, Meta, Link } from "@solidjs/meta";

const SCHEMA = '{"@context":"https://schema.org","@graph":[{"@type":"Product","name":"MS Angle & Channel Supplier Vadodara","description":"MS angle supplier Vadodara, MS channel ISMC supplier Gujarat. Mild Steel IS 2062 — IS 808, IS 2062 E250. Ready stock at CMI Vadodara.","brand":{"@type":"Organization","name":"Creative Metal Industries"},"manufacturer":{"@type":"Organization","name":"Creative Metal Industries"},"offers":{"@type":"AggregateOffer","priceCurrency":"INR","lowPrice":"200","highPrice":"25000","offerCount":"500+","availability":"https://schema.org/InStock"},"url":"https://www.creativemetalind.com/ms-angle-channel-supplier-vadodara"},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"MS Angle & Channel Supplier Vadodara","item":"https://www.creativemetalind.com/ms-angle-channel-supplier-vadodara"}]}]}';

export default function MSAngleChannelSupplierVadodara() {
  return (<>
    <Title>MS Angle & Channel Supplier Vadodara | CMI Vadodara</Title>
    <Meta name="robots" content="index, follow, max-image-preview:large" />
    <Meta name="description" content="MS angle supplier Vadodara, MS channel ISMC supplier Gujarat. IS 808, IS 2062 E250. E250 BR/A, E350 BR/A. Sizes Angle 25x25 to 200x200, Channel ISMC 75 to 400. Ready stock Vadodara. Call +91 99982 80619." />
    <Link rel="canonical" href="https://www.creativemetalind.com/ms-angle-channel-supplier-vadodara" />
    <Meta property="og:title" content="MS Angle & Channel Supplier Vadodara | Creative Metal Industries" />
    <Meta property="og:type" content="website" />
    <Meta property="og:description" content="MS angle supplier Vadodara, MS channel ISMC supplier Gujarat. Ready stock at CMI Vadodara." />
    ...
    <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
      <a href="/" style={{ color: "#E8821A", "text-decoration": "none" }}>Home</a><span style={{ margin: "0 0.5rem" }}>{"\u203A"}</span><span>MS Angle & Channel Supplier Vadodara</span>
    </div>

    <main style={{ "max-width": "960px", margin: "0 auto", padding: "3rem 1.5rem" }}>
      <div style={{ "margin-bottom": "2.5rem", "text-align": "center" }}>
        <h1 style={{ "font-size": "clamp(1.8rem,4vw,2.4rem)", "font-weight": "800", color: "#111827", margin: "0 0 1rem" }}>MS Angle & Channel Supplier Vadodara</h1>
        <p style={{ "font-size": "1.1rem", color: "#4b5563", "max-width": "700px", margin: "0 auto 1.5rem" }}>Creative Metal Industries is a leading supplier of Mild Steel IS 2062 pipes, fittings and related products in India. Complete range as per IS 808, IS 2062 E250. Ready stock at our Vadodara warehouse with nationwide delivery.</p>
      ...
      <section style={{ "margin-bottom": "3rem", background: "#f9fafb", padding: "2rem", "border-radius": "12px" }}>
        ...
        <table style={{ width: "100%", "border-collapse": "collapse", "font-size": "0.92rem" }}>
          <tbody>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600", width: "35%" }}>Material</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>Mild Steel IS 2062</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Standard</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>IS 808, IS 2062 E250</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Grades</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>E250 BR/A, E350 BR/A</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Sizes</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>Angle 25x25 to 200x200, Channel ISMC 75 to 400</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Applications</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>Structural, crane girders, buildings, conveyors</td></tr>
      ...
      <section style={{ "margin-bottom": "3rem" }}>
        ...
        <ul style={{ "line-height": "2", "padding-left": "1.5rem" }}>
          <li><strong>Ready Stock:</strong> Mild Steel IS 2062 pipes and fittings available ex-stock Vadodara</li>
      ...
      <div style={{ background: "linear-gradient(135deg, #E8821A 0%, #d97706 100%)", "border-radius": "12px", padding: "2.5rem", "text-align": "center", color: "#fff" }}>
        <h2 style={{ margin: "0 0 0.5rem" }}>Get Best Price for Mild Steel IS 2062</h2>
