 ...
 * Target: API 5L line pipe supplier India, line pipe X52 X60
 */
import { Title, Meta, Link } from "@solidjs/meta";
import { RelatedPages } from "../components/RelatedPages";

const SCHEMA = '{"@context":"https://schema.org","@graph":[{"@type":"Product","name":"API 5L Line Pipe Supplier India","description":"API 5L line pipe supplier India, line pipe X52 X60. Carbon Steel — API 5L PSL1 & PSL2. Ready stock at CMI Vadodara.","brand":{"@type":"Organization","name":"Creative Metal Industries"},"manufacturer":{"@type":"Organization","name":"Creative Metal Industries"},"offers":{"@type":"AggregateOffer","priceCurrency":"INR","lowPrice":"200","highPrice":"25000","offerCount":"500+","availability":"https://schema.org/InStock"},"url":"https://www.creativemetalind.com/api-5l-line-pipe-supplier-india"},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"API 5L Line Pipe Supplier India","item":"https://www.creativemetalind.com/api-5l-line-pipe-supplier-india"}]}]}';

export default function API5lLinePipeSupplierIndia() {
  return (<>
    <Title>API 5L Line Pipe Supplier India | CMI Vadodara</Title>
    <Meta name="robots" content="index, follow, max-image-preview:large" />
    <Meta name="description" content="API 5L line pipe supplier India, line pipe X52 X60. API 5L PSL1 & PSL2. Gr.B, X42, X46, X52, X56, X60, X65, X70. Sizes 2" to 48", all wall thicknesses. Ready stock Vadodara. Call +91 99982 80619." />
    <Link rel="canonical" href="https://www.creativemetalind.com/api-5l-line-pipe-supplier-india" />
    <Meta property="og:title" content="API 5L Line Pipe Supplier India | Creative Metal Industries" />
    <Meta property="og:type" content="website" />
    <Meta property="og:description" content="API 5L line pipe supplier India, line pipe X52 X60. Ready stock at CMI Vadodara." />
    ...
    <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
      <a href="/" style={{ color: "#E8821A", "text-decoration": "none" }}>Home</a><span style={{ margin: "0 0.5rem" }}>{"\u203A"}</span><span>API 5L Line Pipe Supplier India</span>
    </div>

    <main style={{ "max-width": "960px", margin: "0 auto", padding: "3rem 1.5rem" }}>
      <div style={{ "margin-bottom": "2.5rem", "text-align": "center" }}>
        <h1 style={{ "font-size": "clamp(1.8rem,4vw,2.4rem)", "font-weight": "800", color: "#111827", margin: "0 0 1rem" }}>API 5L Line Pipe Supplier India</h1>
        <p style={{ "font-size": "1.1rem", color: "#4b5563", "max-width": "700px", margin: "0 auto 1.5rem" }}>Creative Metal Industries is a leading supplier of Carbon Steel pipes, fittings and related products in India. Complete range as per API 5L PSL1 & PSL2. Ready stock at our Vadodara warehouse with nationwide delivery.</p>
      ...
      <section style={{ "margin-bottom": "3rem", background: "#f9fafb", padding: "2rem", "border-radius": "12px" }}>
        ...
        <table style={{ width: "100%", "border-collapse": "collapse", "font-size": "0.92rem" }}>
          <tbody>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600", width: "35%" }}>Material</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>Carbon Steel</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Standard</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>API 5L PSL1 & PSL2</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Grades</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>Gr.B, X42, X46, X52, X56, X60, X65, X70</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Sizes</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>2" to 48", all wall thicknesses</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Applications</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>Oil & gas pipelines, transmission, distribution</td></tr>
      ...
      <section style={{ "margin-bottom": "3rem" }}>
        ...
        <ul style={{ "line-height": "2", "padding-left": "1.5rem" }}>
          <li><strong>Ready Stock:</strong> Carbon Steel pipes and fittings available ex-stock Vadodara</li>
      ...
      <div style={{ background: "linear-gradient(135deg, #E8821A 0%, #d97706 100%)", "border-radius": "12px", padding: "2.5rem", "text-align": "center", color: "#fff" }}>
        <h2 style={{ margin: "0 0 0.5rem" }}>Get Best Price for Carbon Steel</h2>
