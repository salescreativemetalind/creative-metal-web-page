...
const SCHEMA = JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"LocalBusiness","@id":"https://www.creativemetalind.com/steel-pipe-supplier-gandhidham#business","parentOrganization":{"@id":"https://www.creativemetalind.com/#organization"},"name":"Creative Metal Industries — Pipe Supplier Gandhidham","description":"Leading steel pipe supplier for Gandhidham, Adipur & Kandla — CS, SS, API pipes for port logistics, GIDC, salt/chemical industry. Same-day delivery from Vadodara.","telephone":"+919998280619","url":"https://www.creativemetalind.com/steel-pipe-supplier-gandhidham","address":{"@type":"PostalAddress","streetAddress":"386/B GIDC Estate, Makarpura","addressLocality":"Vadodara","addressRegion":"Gujarat","postalCode":"390010","addressCountry":"IN"},"areaServed":{"@type":"Place","name":"Gandhidham, Adipur, Kandla","containedInPlace":{"@type":"State","name":"Gujarat"}},"priceRange":"$$"},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"Steel Pipe Supplier Gandhidham","item":"https://www.creativemetalind.com/steel-pipe-supplier-gandhidham"}]}]});
  ...
  return (
    <>
      ...
      <main style={{"max-width":"960px",margin:"0 auto",padding:"3rem 1.5rem"}}>
        ...
        <LocationContent slug="gandhidham" />
      
        <RelatedPages currentPath="/steel-pipe-supplier-gandhidham" />
      </main>
