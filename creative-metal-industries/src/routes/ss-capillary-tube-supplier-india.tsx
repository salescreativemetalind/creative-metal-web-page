...
const SCHEMA = JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"LocalBusiness","@id":"https://www.creativemetalind.com/ss-capillary-tube-supplier-india#business","parentOrganization":{"@id":"https://www.creativemetalind.com/#organization"},"name":"Creative Metal Industries","telephone":"+919998280619","address":{"@type":"PostalAddress","streetAddress":"F-3, 1st Floor, Loha Bhavan, Lakkadpitha Road, Sultanpura","addressLocality":"Vadodara","addressRegion":"Gujarat","postalCode":"390001","addressCountry":"IN"}},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"SS Capillary Tube Supplier India","item":"https://www.creativemetalind.com/ss-capillary-tube-supplier-india"}]}]});
...
export default function SsCapillaryTubeSupplierIndia() {
  return (
    <>
      ...
      <Meta name="description" content="India's leading SS capillary tube supplier. 304, 304L, 316L to ASTM A269. OD 0.5-6mm, tight tolerances. Medical, HPLC, thermocouples, instrumentation." />
