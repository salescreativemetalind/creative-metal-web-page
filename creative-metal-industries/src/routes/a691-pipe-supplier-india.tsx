...
export default function A691PipeSupplierIndia() {
  return (
    <>
      ...
      <Meta name="description" content="A691 EFW pipe supplier India — ASTM A691 Electric Fusion Welded pipe from A387 plate for large-diameter power plant headers. Sizes 16 inch to 60 inch." />
