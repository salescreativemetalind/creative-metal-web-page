...
const PRODUCT_CATEGORIES = [
  {
    ...
    items: [
      { name: "SS Seamless Pipe",  imgs: [I("ss_seamless_pipes.jpeg")], grade: "TP 304, 304L, 316, 316L, 316Ti, 321, 310, 317L, 347, 410, 420, 904L", make: "Sandvik, Salzgitter, Ratnamani, Venus",   note: "ASTM A312/A213. All schedules SCH5S to XXS. 6NB to 600NB. IBR Form III-C. Oil & Gas, Petrochemical, Power." },
            ...
            <address class="contact-details" style="font-style:normal">
              ...
              <div class="contact-item">
                ...
                <div class="contact-item-text">
                  ...
                  <a href="tel:+912654107230">+91 9998280619</a>
                </div>
              </div>
            </address>
          </div>
        ...
        <div class="footer-grid">
          <div class="footer-brand">
            ...
            <nav class="social-links" aria-label="Contact links">
              <a href="mailto:creativemetalind@gmail.com" class="social-link" aria-label="Email">
              ...
              <a href="tel:+919998280619" class="social-link" aria-label="Phone">
                <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor"><path d="M6.62 10.79a15.05 15.05 0 006.59 6.59l2.2-2.2a1 1 0 011.01-.24c1.12.37 2.33.57 3.58.57a1 1 0 011 1V20a1 1 0 01-1 1A17 17 0 013 4a1 1 0 011-1h3.5a1 1 0 011 1c0 1.25.2 2.46.57 3.58a1 1 0 01-.24 1.01l-2.2 2.2z"/></svg>
              </a>
              <a href="https://wa.me/919998280619" class="social-link social-whatsapp" aria-label="WhatsApp" target="_blank" rel="noopener">
              ...
              <a href="https://x.com/CreativeMetal" class="social-link social-x" aria-label="X (Twitter)" target="_blank" rel="noopener">
          ...
          <div>
            ...
            <div style="margin-top:1.5rem">
              <h4>Contact</h4>
              <p style="font-size:0.82rem;color:var(--muted);margin-bottom:0.3rem">Tel: +91 9998280619</p>
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* ── Internal Links — All Product & Location Pages (SEO) ── */}
        <section style={{background:"#f9fafb","border-top":"1px solid #e5e7eb",padding:"4rem 0"}} aria-label="All product and location pages">
          <div class="container">
            <div style={{"text-align":"center","margin-bottom":"2.5rem"}}>
              <span class="section-label">Explore Our Complete Range</span>
              <h2 style={{"font-size":"clamp(1.3rem,3vw,1.8rem)"}}>Product Pages — All Materials &amp; Grades</h2>
            </div>
            ...
            <h3 style={{"font-size":"1rem","font-weight":"700",color:"#111827","margin-bottom":"0.75rem"}}>Duplex &amp; Super Duplex</h3>
            <div style={{display:"flex","flex-wrap":"wrap",gap:"0.5rem","margin-bottom":"1.5rem"}}>
              {[
            ...
            <h3 style={{"font-size":"1rem","font-weight":"700",color:"#111827","margin-bottom":"0.75rem"}}>Exotic Alloys — Inconel, Monel, Hastelloy, Incoloy</h3>
            <div style={{display:"flex","flex-wrap":"wrap",gap:"0.5rem","margin-bottom":"1.5rem"}}>
              {[
            ...
            <h3 style={{"font-size":"1rem","font-weight":"700",color:"#111827","margin-bottom":"0.75rem"}}>Carbon Steel, Alloy Steel &amp; Structural</h3>
            <div style={{display:"flex","flex-wrap":"wrap",gap:"0.5rem","margin-bottom":"1.5rem"}}>
              {[
