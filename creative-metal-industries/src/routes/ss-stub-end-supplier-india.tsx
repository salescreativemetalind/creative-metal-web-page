/**
 * /ss-stub-end-supplier-india
 * Target: "SS stub end lap joint supplier India"
 */
  ...
  "@graph": [
    
    {
      ...
      "itemListElement": [
        ...
        { "@type": "ListItem", "position": 2, "name": "Stainless Steel Stub End Supplier India — Lap Joint", "item": "https://www.creativemetalind.com/ss-stub-end-supplier-india" }
      ]
    }
  ]
});
...
const FAQ_SCHEMA = JSON.stringify({
  ...
  "mainEntity": [
    { "@type": "Question", "name": "What is Stainless Steel Stub End?", "acceptedAnswer": { "@type": "Answer", "text": "Stainless Steel Stub End is manufactured per ASTM A403, MSS SP-43 in grades WP304, WP304L, WP316, WP316L, WP321, WP347. Creative Metal Industries stocks all sizes with immediate dispatch from Vadodara, Gujarat. Every piece comes with Mill Test Certificate (EN 10204 3.1/3.2) and can be supplied with IBR Form III-C, PMI report, and third-party inspection as required." } },
    { "@type": "Question", "name": "What sizes of Stainless Steel Stub End do you stock?", "acceptedAnswer": { "@type": "Answer", "text": "We stock Stainless Steel Stub End across the complete size range as per ASTM A403, MSS SP-43. Standard sizes are available for immediate dispatch while non-standard sizes can be arranged on indent from approved mills within 2-4 weeks. Contact us at +91 99982 80619 for specific size availability." } },
    { "@type": "Question", "name": "Do you supply Stainless Steel Stub End with test certificates?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, every Stainless Steel Stub End from CMI is supplied with original Mill Test Certificate (MTC) per EN 10204 Type 3.1 or 3.2. Additional documentation includes IBR Form III-C, PMI certificate, NACE compliance letter, IGC test report, and third-party inspection from DNV, TUV, SGS, or Lloyd's — as per your project requirements." } },
    { "@type": "Question", "name": "What is the price of Stainless Steel Stub End in India?", "acceptedAnswer": { "@type": "Answer", "text": "Pricing for Stainless Steel Stub End varies based on grade, size, quantity, and current raw material costs. As a direct stockist with mill relationships, CMI offers competitive pricing without broker margins. Call +91 99982 80619 or WhatsApp for an instant quotation with guaranteed 4-hour response." } },
    { "@type": "Question", "name": "Can you supply Stainless Steel Stub End for export?", "acceptedAnswer": { "@type": "Answer", "text": "Absolutely. Creative Metal Industries exports Stainless Steel Stub End to 50+ countries including UAE, Saudi Arabia, Oman, Kuwait, Qatar, USA, UK, and Southeast Asia. We handle complete export documentation including commercial invoice, packing list, certificate of origin, fumigation certificate, and seaworthy wooden box/pallet packing." } }
  ]
});

export default function SSStubEndSupplierIndia() {
  return (
    <>
      <Title>SS Stub End Supplier India | CMI Vadodara</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="SS stub end lap joint supplier India. 304, 316L, duplex grades. ASTM A403 WP304/316L. Type A & B. Stock at CMI. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/ss-stub-end-supplier-india" />
      <Meta property="og:title" content="SS Stub End Supplier India | CMI Vadodara" />
      <Meta property="og:type" content="website" />
      <Meta property="og:description" content="SS stub end lap joint supplier India. 304, 316L, duplex grades. ASTM A403 WP304/316L. Type A & B. Stock at CMI. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/ss-stub-end-supplier-india" />
      ...
      <nav style={{ background: "#fff", "border-bottom": "1px solid #e5e7eb", padding: "1rem 1.5rem", display: "flex", "align-items": "center", gap: "1rem" }}>
        <a href="/"><img src="/logo_cmi.png" alt="Creative Metal Industries — Stainless Steel Stub End Supplier India" width="140" height="71" /></a>
        <div style={{ flex: 1 }} />
        <a href="/#contact" style={{ background: "#E8821A", color: "#fff", padding: "0.5rem 1.2rem", "border-radius": "6px", "font-weight": "700", "font-size": "0.85rem", "text-decoration": "none" }}>Get Quote</a>
      </nav>
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        <a href="/" style={{ color: "#E8821A", "text-decoration": "none" }}>Home</a><span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Stainless Steel Stub End Supplier India — Lap Joint</span>
      </div>

      <main style={{ "max-width": "960px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        <h1 style={{ "font-size": "clamp(1.8rem,4vw,2.5rem)", "font-weight": "800", color: "#111827", margin: "0 0 1.5rem", "line-height": "1.2" }}>
          Stainless Steel Stub End Supplier India — Lap Joint
        </h1>

        <p style={{ "font-size": "1.05rem", color: "#374151", "line-height": "1.8", "margin-bottom": "1.5rem" }}>
          <strong>Creative Metal Industries</strong> is India's trusted supplier and stockist of <strong>Stainless Steel Stub End</strong> manufactured per <strong>ASTM A403, MSS SP-43</strong>. We stock grades WP304, WP304L, WP316, WP316L, WP321, WP347 for immediate dispatch from our Vadodara (Gujarat) warehouse. As a leading industrial metal supplier with 13+ years of experience, we serve refineries, power plants, chemical processing units, EPC contractors, and fabrication workshops across India and 50+ export destinations.
        </p>
        ...
        <p style={{ "font-size": "0.95rem", color: "#374151", "line-height": "1.8", "margin-bottom": "1rem" }}>
          Our Stainless Steel Stub End inventory covers the following grades per ASTM A403, MSS SP-43: <strong>WP304, WP304L, WP316, WP316L, WP321, WP347</strong>. Each product is manufactured at approved mills under strict quality control and supplied with full traceability documentation. We maintain ready stock across standard sizes with the ability to source non-standard requirements on indent within 2-4 weeks from production.
        </p>
        <p style={{ "font-size": "0.95rem", color: "#374151", "line-height": "1.8", "margin-bottom": "1rem" }}>
        ...
        <div style={{ overflow: "auto", border: "1px solid #e5e7eb", "border-radius": "10px", "margin-bottom": "1.5rem" }}>
          <table style={{ width: "100%", "border-collapse": "collapse", "font-size": "0.88rem" }}>
            ...
            <tbody>
              ...
              <tr style={{ background: "#f9fafb" }}><td style={{ padding: "0.6rem 1rem", "font-weight": "600" }}>Product</td><td style={{ padding: "0.6rem 1rem" }}>Stub End</td></tr>
              <tr style={{ background: "#fff" }}><td style={{ padding: "0.6rem 1rem", "font-weight": "600" }}>Standard</td><td style={{ padding: "0.6rem 1rem" }}>ASTM A403, MSS SP-43</td></tr>
              <tr style={{ background: "#f9fafb" }}><td style={{ padding: "0.6rem 1rem", "font-weight": "600" }}>Grades</td><td style={{ padding: "0.6rem 1rem" }}>WP304, WP304L, WP316, WP316L, WP321, WP347</td></tr>
        ...
        <div style={{ background: "#f9fafb", border: "1px solid #e5e7eb", "border-radius": "10px", padding: "1.5rem", "margin-bottom": "2rem" }}>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What is Stainless Steel Stub End?</h3>
          <p style={{ "font-size": "0.9rem", color: "#374151", "line-height": "1.7", "margin-bottom": "1.25rem" }}>Stainless Steel Stub End is manufactured per ASTM A403, MSS SP-43 in grades WP304, WP304L, WP316, WP316L, WP321, WP347. It is used across oil & gas, power, chemical, pharma, and infrastructure industries. CMI stocks all sizes with immediate dispatch from Vadodara.</p>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What documentation do you provide?</h3>
          <p style={{ "font-size": "0.9rem", color: "#374151", "line-height": "1.7", "margin-bottom": "1.25rem" }}>Every Stub End comes with MTC (EN 10204 3.1/3.2), IBR Form III-C (if applicable), PMI certificate, NACE compliance, and third-party inspection as per project requirements.</p>
        ...
        <div style={{ background: "linear-gradient(135deg,#E8821A,#d85c2a)", "border-radius": "12px", padding: "2rem", "text-align": "center", color: "#fff" }}>
          <h3 style={{ "font-size": "1.3rem", "font-weight": "700", margin: "0 0 0.75rem" }}>Need Stainless Steel Stub End? Get Instant Quote</h3>
        ...
        <RelatedPages currentPath="/ss-stub-end-supplier-india" />
      </main>
    </>
  );
}
