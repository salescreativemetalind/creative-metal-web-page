 ...
 * Target: SS sheet supplier Vadodara, SS 304 sheet 2B finish
 */
import { Title, Meta, Link } from "@solidjs/meta";
import { RelatedPages } from "../components/RelatedPages";

const SCHEMA = '{"@context":"https://schema.org","@graph":[{"@type":"Product","name":"SS Sheet Supplier Vadodara","description":"SS sheet supplier Vadodara, SS 304 sheet 2B finish. Stainless Steel — ASTM A240 / A480. Ready stock at CMI Vadodara.","brand":{"@type":"Organization","name":"Creative Metal Industries"},"manufacturer":{"@type":"Organization","name":"Creative Metal Industries"},"offers":{"@type":"AggregateOffer","priceCurrency":"INR","lowPrice":"200","highPrice":"25000","offerCount":"500+","availability":"https://schema.org/InStock"},"url":"https://www.creativemetalind.com/ss-sheet-supplier-vadodara"},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"SS Sheet Supplier Vadodara","item":"https://www.creativemetalind.com/ss-sheet-supplier-vadodara"}]}]}';

export default function SSSheetSupplierVadodara() {
  return (<>
    <Title>SS Sheet Supplier Vadodara | CMI Vadodara</Title>
    <Meta name="robots" content="index, follow, max-image-preview:large" />
    <Meta name="description" content="SS sheet supplier Vadodara, SS 304 sheet 2B finish. ASTM A240 / A480. 304, 316L, 321, 310, 409, 430, 904L. Sizes 0.4mm to 6mm thick, all widths. Ready stock Vadodara. Call +91 99982 80619." />
    <Link rel="canonical" href="https://www.creativemetalind.com/ss-sheet-supplier-vadodara" />
    <Meta property="og:title" content="SS Sheet Supplier Vadodara | Creative Metal Industries" />
    <Meta property="og:type" content="website" />
    <Meta property="og:description" content="SS sheet supplier Vadodara, SS 304 sheet 2B finish. Ready stock at CMI Vadodara." />
    ...
    <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
      <a href="/" style={{ color: "#E8821A", "text-decoration": "none" }}>Home</a><span style={{ margin: "0 0.5rem" }}>{"\u203A"}</span><span>SS Sheet Supplier Vadodara</span>
    </div>

    <main style={{ "max-width": "960px", margin: "0 auto", padding: "3rem 1.5rem" }}>
      <div style={{ "margin-bottom": "2.5rem", "text-align": "center" }}>
        <h1 style={{ "font-size": "clamp(1.8rem,4vw,2.4rem)", "font-weight": "800", color: "#111827", margin: "0 0 1rem" }}>SS Sheet Supplier Vadodara</h1>
        <p style={{ "font-size": "1.1rem", color: "#4b5563", "max-width": "700px", margin: "0 auto 1.5rem" }}>Creative Metal Industries is a leading supplier of Stainless Steel pipes, fittings and related products in India. Complete range as per ASTM A240 / A480. Ready stock at our Vadodara warehouse with nationwide delivery.</p>
      ...
      <section style={{ "margin-bottom": "3rem", background: "#f9fafb", padding: "2rem", "border-radius": "12px" }}>
        ...
        <table style={{ width: "100%", "border-collapse": "collapse", "font-size": "0.92rem" }}>
          <tbody>
            ...
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Standard</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>ASTM A240 / A480</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Grades</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>304, 316L, 321, 310, 409, 430, 904L</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Sizes</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>0.4mm to 6mm thick, all widths</td></tr>
            <tr><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb", "font-weight": "600" }}>Applications</td><td style={{ padding: "0.7rem", "border-bottom": "1px solid #e5e7eb" }}>Kitchen, pharma, architecture, food processing</td></tr>
