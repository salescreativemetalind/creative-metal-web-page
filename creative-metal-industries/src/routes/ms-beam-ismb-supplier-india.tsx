...
const SCHEMA = JSON.stringify({
  ...
  "@graph": [
    {
      "@type": "Product",
      "name": "MS Beam ISMB Supplier India — Structural Steel",
      "description": "MS ISMB beam supplier India IS 808. ISMB 100 to 600. SAIL, Jindal structural. CMI Vadodara Gujarat. Call +91 99982 80619.",
      ...
      "url": "https://www.creativemetalind.com/ms-beam-ismb-supplier-india"
    },
    {
      "@type": "BreadcrumbList",
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://www.creativemetalind.com" },
        { "@type": "ListItem", "position": 2, "name": "MS Beam ISMB Supplier India — Structural Steel", "item": "https://www.creativemetalind.com/ms-beam-ismb-supplier-india" }
      ]
    }
  ]
});
...
const FAQ_SCHEMA = JSON.stringify({
  ...
  "mainEntity": [
    { "@type": "Question", "name": "What is Mild Steel Beam (ISMB)?", "acceptedAnswer": { "@type": "Answer", "text": "Mild Steel Beam (ISMB) is manufactured per IS 808, IS 2062 in grades ISMB 100, 150, 200, 250, 300, 350, 400, 450, 500, 600. Creative Metal Industries stocks all sizes with immediate dispatch from Vadodara, Gujarat. Every piece comes with Mill Test Certificate (EN 10204 3.1/3.2) and can be supplied with IBR Form III-C, PMI report, and third-party inspection as required." } },
    { "@type": "Question", "name": "What sizes of Mild Steel Beam (ISMB) do you stock?", "acceptedAnswer": { "@type": "Answer", "text": "We stock Mild Steel Beam (ISMB) across the complete size range as per IS 808, IS 2062. Standard sizes are available for immediate dispatch while non-standard sizes can be arranged on indent from approved mills within 2-4 weeks. Contact us at +91 99982 80619 for specific size availability." } },
    { "@type": "Question", "name": "Do you supply Mild Steel Beam (ISMB) with test certificates?", "acceptedAnswer": { "@type": "Answer", "text": "Yes, every Mild Steel Beam (ISMB) from CMI is supplied with original Mill Test Certificate (MTC) per EN 10204 Type 3.1 or 3.2. Additional documentation includes IBR Form III-C, PMI certificate, NACE compliance letter, IGC test report, and third-party inspection from DNV, TUV, SGS, or Lloyd's — as per your project requirements." } },
    { "@type": "Question", "name": "What is the price of Mild Steel Beam (ISMB) in India?", "acceptedAnswer": { "@type": "Answer", "text": "Pricing for Mild Steel Beam (ISMB) varies based on grade, size, quantity, and current raw material costs. As a direct stockist with mill relationships, CMI offers competitive pricing without broker margins. Call +91 99982 80619 or WhatsApp for an instant quotation with guaranteed 4-hour response." } },
    { "@type": "Question", "name": "Can you supply Mild Steel Beam (ISMB) for export?", "acceptedAnswer": { "@type": "Answer", "text": "Absolutely. Creative Metal Industries exports Mild Steel Beam (ISMB) to 50+ countries including UAE, Saudi Arabia, Oman, Kuwait, Qatar, USA, UK, and Southeast Asia. We handle complete export documentation including commercial invoice, packing list, certificate of origin, fumigation certificate, and seaworthy wooden box/pallet packing." } }
  ]
});

export default function MSBeamIsmbSupplierIndia() {
  return (
    <>
      <Title>MS Beam ISMB Supplier India | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="MS ISMB beam supplier India IS 808. ISMB 100 to 600. SAIL, Jindal structural. CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/ms-beam-ismb-supplier-india" />
      <Meta property="og:title" content="MS Beam ISMB Supplier India | CMI" />
      <Meta property="og:type" content="website" />
      <Meta property="og:description" content="MS ISMB beam supplier India IS 808. ISMB 100 to 600. SAIL, Jindal structural. CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/ms-beam-ismb-supplier-india" />
      ...
      <nav style={{ background: "#fff", "border-bottom": "1px solid #e5e7eb", padding: "1rem 1.5rem", display: "flex", "align-items": "center", gap: "1rem" }}>
        <a href="/"><img src="/logo_cmi.png" alt="Creative Metal Industries — Mild Steel Beam (ISMB) Supplier India" width="140" height="71" /></a>
        <div style={{ flex: 1 }} />
        <a href="/#contact" style={{ background: "#E8821A", color: "#fff", padding: "0.5rem 1.2rem", "border-radius": "6px", "font-weight": "700", "font-size": "0.85rem", "text-decoration": "none" }}>Get Quote</a>
      </nav>
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        <a href="/" style={{ color: "#E8821A", "text-decoration": "none" }}>Home</a><span style={{ margin: "0 0.5rem" }}>›</span>
        <span>MS Beam ISMB Supplier India — Structural Steel</span>
      </div>

      <main style={{ "max-width": "960px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        <h1 style={{ "font-size": "clamp(1.8rem,4vw,2.5rem)", "font-weight": "800", color: "#111827", margin: "0 0 1.5rem", "line-height": "1.2" }}>
          MS Beam ISMB Supplier India — Structural Steel
        </h1>
        ...
        <p style={{ "font-size": "0.95rem", color: "#374151", "line-height": "1.8", "margin-bottom": "1rem" }}>
          Our Mild Steel Beam (ISMB) inventory covers the following grades per IS 808, IS 2062: <strong>ISMB 100, 150, 200, 250, 300, 350, 400, 450, 500, 600</strong>. Each product is manufactured at approved mills under strict quality control and supplied with full traceability documentation. We maintain ready stock across standard sizes with the ability to source non-standard requirements on indent within 2-4 weeks from production.
        </p>
        <p style={{ "font-size": "0.95rem", color: "#374151", "line-height": "1.8", "margin-bottom": "1rem" }}>
        ...
        <div style={{ overflow: "auto", border: "1px solid #e5e7eb", "border-radius": "10px", "margin-bottom": "1.5rem" }}>
          <table style={{ width: "100%", "border-collapse": "collapse", "font-size": "0.88rem" }}>
            ...
            <tbody>
              ...
              <tr style={{ background: "#f9fafb" }}><td style={{ padding: "0.6rem 1rem", "font-weight": "600" }}>Product</td><td style={{ padding: "0.6rem 1rem" }}>Beam (ISMB)</td></tr>
              ...
              <tr style={{ background: "#f9fafb" }}><td style={{ padding: "0.6rem 1rem", "font-weight": "600" }}>Grades</td><td style={{ padding: "0.6rem 1rem" }}>ISMB 100, 150, 200, 250, 300, 350, 400, 450, 500, 600</td></tr>
        ...
        <div style={{ background: "#f9fafb", border: "1px solid #e5e7eb", "border-radius": "10px", padding: "1.5rem", "margin-bottom": "2rem" }}>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What is Mild Steel Beam (ISMB)?</h3>
          <p style={{ "font-size": "0.9rem", color: "#374151", "line-height": "1.7", "margin-bottom": "1.25rem" }}>Mild Steel Beam (ISMB) is manufactured per IS 808, IS 2062 in grades ISMB 100, 150, 200, 250, 300, 350, 400, 450, 500, 600. It is used across oil & gas, power, chemical, pharma, and infrastructure industries. CMI stocks all sizes with immediate dispatch from Vadodara.</p>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What documentation do you provide?</h3>
          <p style={{ "font-size": "0.9rem", color: "#374151", "line-height": "1.7", "margin-bottom": "1.25rem" }}>Every Beam (ISMB) comes with MTC (EN 10204 3.1/3.2), IBR Form III-C (if applicable), PMI certificate, NACE compliance, and third-party inspection as per project requirements.</p>
        ...
        <div style={{ background: "linear-gradient(135deg,#E8821A,#d85c2a)", "border-radius": "12px", padding: "2rem", "text-align": "center", color: "#fff" }}>
          <h3 style={{ "font-size": "1.3rem", "font-weight": "700", margin: "0 0 0.75rem" }}>Need Mild Steel Beam (ISMB)? Get Instant Quote</h3>
