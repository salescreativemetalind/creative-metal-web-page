...
const SCHEMA = JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"Duplex 2205 Plate Supplier India","item":"https://www.creativemetalind.com/duplex-2205-plate-supplier-india"}]}]});
...
export default function Duplex2205PlateSupplierIndia() {
  return (
    <>
      ...
      <Meta name="description" content="Duplex 2205 plate supplier India — ASTM A240 UNS S31803/S32205. 2x yield strength of 316L, PREN ~35. Thickness 3-100mm. Ready stock Vadodara." />
