...
const SCHEMA = JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"Incoloy 825 Pipe Supplier India","item":"https://www.creativemetalind.com/incoloy-825-pipe-supplier-india"}]}]});
...
export default function Incoloy825PipeSupplierIndia() {
  return (
    <>
      ...
      <Meta name="description" content="Incoloy 825 pipe & tube supplier India — ASTM B423 N08825 seamless pipes. Acid resistant, NACE MR0175 sour service. Sulphuric acid, oil & gas." />
