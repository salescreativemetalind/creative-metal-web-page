...
export default function CompressionFittingsSupplierIndia() {
  return (
    <>
      ...
      <Meta name="description" content="Compression fittings supplier India — Swagelok/Parker type double ferrule tube fittings. SS 316, SS 304, Alloy 625, Monel 400, Duplex 2205." />
