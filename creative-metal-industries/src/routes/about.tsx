...
export default function AboutPage() {
  return (
    <PageLayout active="About Us">
      ...
      <Meta name="twitter:title" content="About Us | Creative Metal Industries Vadodara" />
      <Meta name="twitter:description" content="Creative Metal Industries — established 2012, Vadodara. Manufacturer, stockist and supplier of SS, Carbon & Alloy Steel Pipes, Plates, Fittings, Flanges and Exotic Alloys. Learn about our team, facilities and certifications." />
