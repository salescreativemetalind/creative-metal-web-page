...
const SCHEMA = JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"LocalBusiness","@id":"https://www.creativemetalind.com/clad-plate-supplier-india#business","parentOrganization":{"@id":"https://www.creativemetalind.com/#organization"},"name":"Creative Metal Industries","telephone":"+919998280619","address":{"@type":"PostalAddress","streetAddress":"F-3, 1st Floor, Loha Bhavan, Lakkadpitha Road, Sultanpura","addressLocality":"Vadodara","addressRegion":"Gujarat","postalCode":"390001","addressCountry":"IN"}},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"Clad Plate Supplier India","item":"https://www.creativemetalind.com/clad-plate-supplier-india"}]}]});
...
export default function CladPlateSupplierIndia() {
  return (
    <>
      ...
      <Meta name="description" content="Clad plate supplier India — explosion bonded &amp; roll bonded bimetallic plates. ASTM A263 (SS clad), A265 (Ni alloy clad)." />
