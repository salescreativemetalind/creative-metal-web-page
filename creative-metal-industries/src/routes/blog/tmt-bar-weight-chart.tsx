/**
 * /blog/tmt-bar-weight-chart
 * Target: "TMT bar weight chart 8mm to 32mm per metre"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "TMT Bar Weight Chart — 8mm to 32mm Per Metre", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/tmt-bar-weight-chart",
  "description": "TMT bar weight chart 8mm to 32mm — kg per metre & per piece. Fe 500D. Free chart CMI Vadodara. Call +91 99982 80619."
});
...
export default function TmtBarWeightChart() {
  return (
    <>
      <Title>TMT Bar Weight Chart Per Metre | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="TMT bar weight chart 8mm to 32mm — kg per metre & per piece. Fe 500D. Free chart CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/tmt-bar-weight-chart" />
      <Meta property="og:title" content="TMT Bar Weight Chart Per Metre | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="TMT bar weight chart 8mm to 32mm — kg per metre & per piece. Fe 500D. Free chart CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/tmt-bar-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>TMT Bar Weight Chart — 8mm to 32mm Per Metre</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/tmt-bar-weight-chart" />
      </main>
    </>
  );
}
