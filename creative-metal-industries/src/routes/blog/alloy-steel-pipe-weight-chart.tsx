/**
 * /blog/alloy-steel-pipe-weight-chart
 * Target: "alloy steel pipe weight chart P91 P22 P11"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Alloy Steel Pipe Weight Chart — P91, P22, P11", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/alloy-steel-pipe-weight-chart",
  "description": "Alloy steel pipe weight chart P91/P22/P11 — ASTM A335 per metre. All schedules. CMI Vadodara. Call +91 99982 80619."
});
...
export default function AlloySteelPipeWeightChart() {
  return (
    <>
      <Title>Alloy Steel Pipe Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Alloy steel pipe weight chart P91/P22/P11 — ASTM A335 per metre. All schedules. CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/alloy-steel-pipe-weight-chart" />
      <Meta property="og:title" content="Alloy Steel Pipe Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Alloy steel pipe weight chart P91/P22/P11 — ASTM A335 per metre. All schedules. CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/alloy-steel-pipe-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Alloy Steel Pipe Weight Chart — P91, P22, P11</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/alloy-steel-pipe-weight-chart" />
      </main>
    </>
  );
}
