/**
 * /blog/ms-plate-weight-calculator
 * Target: "MS plate weight calculator per sheet"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "MS Plate Weight Calculator Per Sheet", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ms-plate-weight-calculator",
  "description": "MS plate weight calculator per sheet — IS 2062 all sizes. Free online tool. CMI Vadodara Gujarat. Call +91 99982 80619."
});
...
export default function MSPlateWeightCalculator() {
  return (
    <>
      <Title>MS Plate Weight Calculator | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="MS plate weight calculator per sheet — IS 2062 all sizes. Free online tool. CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ms-plate-weight-calculator" />
      <Meta property="og:title" content="MS Plate Weight Calculator | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="MS plate weight calculator per sheet — IS 2062 all sizes. Free online tool. CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ms-plate-weight-calculator" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>MS Plate Weight Calculator Per Sheet</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ms-plate-weight-calculator" />
      </main>
    </>
  );
}
