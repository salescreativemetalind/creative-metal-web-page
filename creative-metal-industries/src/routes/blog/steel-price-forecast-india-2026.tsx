/**
 * /blog/steel-price-forecast-india-2026
 * Target: "steel price forecast India 2026 2027 trend"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Steel Price Forecast India 2026-2027 — Trends", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/steel-price-forecast-india-2026",
  "description": "Steel price forecast India 2026-2027 — SS, CS, alloy trends. Expert analysis by CMI Vadodara. Plan procurement. Call +91 99982 80619."
});

const FAQ_SCHEMA = JSON.stringify({
  "@context": "https://schema.org", "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "What is the current steel price forecast rate?", "acceptedAnswer": { "@type": "Answer", "text": "The current rate varies based on grade, size, quantity, and market conditions (LME nickel, import duty, demand). Creative Metal Industries provides real-time pricing — call +91 99982 80619 for today's rate with quantity discounts. We offer 3-7 day price validity on formal quotations." } },
...
export default function SteelPriceForecastIndia2026() {
  return (
    <>
      <Title>Steel Price Forecast India 2026-27 | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Steel price forecast India 2026-2027 — SS, CS, alloy trends. Expert analysis by CMI Vadodara. Plan procurement. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/steel-price-forecast-india-2026" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Steel Price Forecast India 2026-2027 — Trends</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <div style={{ background: "#f9fafb", border: "1px solid #e5e7eb", "border-radius": "10px", padding: "1.5rem", "margin-bottom": "2rem" }}>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What is the current steel price forecast rate?</h3>
        ...
        <RelatedPages currentPath="/blog/steel-price-forecast-india-2026" />
      </main>
    </>
  );
}
