/**
 * /blog/gi-pipe-weight-chart
 * Target: "GI pipe weight chart all sizes galvanised"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "GI Pipe Weight Chart — All Sizes Galvanised", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/gi-pipe-weight-chart",
  "description": "GI pipe weight chart — galvanised, all sizes per metre. IS 1239 light/medium/heavy. CMI Vadodara. Call +91 99982 80619."
});
...
export default function GiPipeWeightChart() {
  return (
    <>
      <Title>GI Pipe Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="GI pipe weight chart — galvanised, all sizes per metre. IS 1239 light/medium/heavy. CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/gi-pipe-weight-chart" />
      <Meta property="og:title" content="GI Pipe Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="GI pipe weight chart — galvanised, all sizes per metre. IS 1239 light/medium/heavy. CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/gi-pipe-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>GI Pipe Weight Chart — All Sizes Galvanised</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/gi-pipe-weight-chart" />
      </main>
    </>
  );
}
