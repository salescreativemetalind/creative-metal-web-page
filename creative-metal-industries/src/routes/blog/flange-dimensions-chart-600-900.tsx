/**
 * /blog/flange-dimensions-chart-600-900
 * Target: "flange dimensions chart class 600 900 B16.5"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Flange Dimensions Chart — Class 600 & 900 (B16.5)", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/flange-dimensions-chart-600-900",
  "description": "flange dimensions chart class 600 900 B16.5. Expert guide by Creative Metal Industries Vadodara. Call +91 99982 80619 for enquiry."
});
...
export default function FlangeDimensionsChart600900() {
  return (
    <>
      <Title>Flange Dimensions Chart — Class 600 & 900 (B16.5) | CMI I...</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="flange dimensions chart class 600 900 B16.5. Expert guide by Creative Metal Industries Vadodara. Call +91 99982 80619 for enquiry." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/flange-dimensions-chart-600-900" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Flange Dimensions Chart — Class 600 & 900 (B16.5)</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        <div style={{ "margin-bottom": "2.5rem" }}>
          ...
          <h1 style={{ "font-size": "clamp(1.8rem,4vw,2.5rem)", "font-weight": "800", color: "#111827", margin: "1rem 0 1.25rem", "line-height": "1.2" }}>
            Flange Dimensions Chart — Class 600 & 900 (B16.5)
          </h1>
          <p style={{ "font-size": "1.05rem", color: "#374151", "line-height": "1.8" }}>
            This <strong>flange dimensions chart — class 600 & 900 (b16.5)</strong> provides engineers, procurement teams, and fabricators with accurate dimensional reference data. Bookmark this page for quick access during material take-offs, inspection verification, and project estimation. All dimensions conform to the applicable ASTM, ASME, IS, or DIN standards. Creative Metal Industries, Vadodara stocks material across the full size range — call <strong>+91 99982 80619</strong> for specific size availability and pricing.
          </p>
        </div>
        ...
        <RelatedPages currentPath="/blog/flange-dimensions-chart-600-900" />
      </main>
    </>
  );
}
