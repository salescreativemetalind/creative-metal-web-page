/**
 * /blog/cs-pipe-weight-chart
 * Target: "carbon steel pipe weight chart A106 per metre"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Carbon Steel Pipe Weight Chart — A106 Per Metre", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/cs-pipe-weight-chart",
  "description": "Carbon steel pipe weight chart ASTM A106 per metre — SCH 40/80/160. All sizes. By CMI Vadodara. Call +91 99982 80619."
});
...
export default function CSPipeWeightChart() {
  return (
    <>
      <Title>CS Pipe Weight Chart A106 | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Carbon steel pipe weight chart ASTM A106 per metre — SCH 40/80/160. All sizes. By CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/cs-pipe-weight-chart" />
      <Meta property="og:title" content="CS Pipe Weight Chart A106 | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Carbon steel pipe weight chart ASTM A106 per metre — SCH 40/80/160. All sizes. By CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/cs-pipe-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Carbon Steel Pipe Weight Chart — A106 Per Metre</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/cs-pipe-weight-chart" />
      </main>
    </>
  );
}
