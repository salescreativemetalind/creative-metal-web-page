/**
 * /blog/flange-weight-chart
 * Target: "flange weight chart all sizes 150 300 600"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Flange Weight Chart — All Sizes Class 150-600", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/flange-weight-chart",
  "description": "Flange weight chart — class 150, 300, 600 all sizes. ASME B16.5. Free download. CMI Vadodara. Call +91 99982 80619."
});
...
export default function FlangeWeightChart() {
  return (
    <>
      <Title>Flange Weight Chart All Classes | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Flange weight chart — class 150, 300, 600 all sizes. ASME B16.5. Free download. CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/flange-weight-chart" />
      <Meta property="og:title" content="Flange Weight Chart All Classes | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Flange weight chart — class 150, 300, 600 all sizes. ASME B16.5. Free download. CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/flange-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Flange Weight Chart — All Sizes Class 150-600</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/flange-weight-chart" />
      </main>
    </>
  );
}
