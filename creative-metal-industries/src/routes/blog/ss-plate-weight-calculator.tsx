/**
 * /blog/ss-plate-weight-calculator
 * Target: "SS plate weight calculator per sheet kg"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "SS Plate Weight Calculator — Per Sheet Kg", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ss-plate-weight-calculator",
  "description": "SS plate weight calculator — per sheet kg. 304/316L all thickness. Free tool by CMI Vadodara. Call +91 99982 80619."
});
...
export default function SSPlateWeightCalculator() {
  return (
    <>
      <Title>SS Plate Weight Calculator | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="SS plate weight calculator — per sheet kg. 304/316L all thickness. Free tool by CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ss-plate-weight-calculator" />
      <Meta property="og:title" content="SS Plate Weight Calculator | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="SS plate weight calculator — per sheet kg. 304/316L all thickness. Free tool by CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ss-plate-weight-calculator" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>SS Plate Weight Calculator — Per Sheet Kg</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ss-plate-weight-calculator" />
      </main>
    </>
  );
}
