...
export default function HasteloyC276Guide() {
  return (
    <>
      ...
      <Meta property="og:description" content="Hastelloy C-276 (UNS N10276) — the ultimate nickel alloy for HCl, H₂SO₄, wet chlorine, and mixed acid environments. Composition, properties, applications, welding. Industrial raw material supplier Gujarat." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/hastelloy-c276-guide" />
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Hastelloy C-276 (UNS N10276) — the ultimate nickel alloy for HCl, H₂SO₄, wet chlorine, and mixed acid environments." />
