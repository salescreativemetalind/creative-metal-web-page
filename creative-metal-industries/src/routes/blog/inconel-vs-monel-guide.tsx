...
export default function InconelVsMonelGuide() {
  return (
    <>
      <Title>Inconel vs Monel — Which Nickel Alloy to Choose? | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Inconel vs Monel compared — Ni-Cr vs Ni-Cu alloys, oxidising vs reducing corrosion environments, temperature limits, mechanical properties and cost." />
