/**
 * /blog/ss-304-sheet-price-per-kg
 * Target: "SS 304 sheet price per kg India 2B finish"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "SS 304 Sheet Price Per Kg India — 2B Finish", "image": "https://www.creativemetalind.com/og-image.jpg",
...
export default function SS304SheetPricePerKg() {
  return (
    <>
      <Title>SS 304 Sheet Price Per Kg India | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="SS 304 sheet price per kg India 2B & No.4 finish. July 2026 rates. Jindal, SAIL stock at CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ss-304-sheet-price-per-kg" />
      <Meta property="og:title" content="SS 304 Sheet Price Per Kg India | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="SS 304 sheet price per kg India 2B & No.4 finish. July 2026 rates. Jindal, SAIL stock at CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ss-304-sheet-price-per-kg" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>SS 304 Sheet Price Per Kg India — 2B Finish</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <div style={{ background: "#f9fafb", border: "1px solid #e5e7eb", "border-radius": "10px", padding: "1.5rem", "margin-bottom": "2rem" }}>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What is the current SS 304 sheet price per kg rate?</h3>
        ...
        <RelatedPages currentPath="/blog/ss-304-sheet-price-per-kg" />
      </main>
    </>
  );
}
