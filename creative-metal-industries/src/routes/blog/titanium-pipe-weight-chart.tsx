/**
 * /blog/titanium-pipe-weight-chart
 * Target: "titanium pipe weight chart Grade 2 5"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Titanium Pipe Weight Chart — Grade 2 & 5", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/titanium-pipe-weight-chart",
  "description": "Titanium Grade 2 & 5 pipe weight chart per metre — ASTM B861. CMI Vadodara exotic stockist. Call +91 99982 80619."
});
...
export default function TitaniumPipeWeightChart() {
  return (
    <>
      <Title>Titanium Pipe Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Titanium Grade 2 & 5 pipe weight chart per metre — ASTM B861. CMI Vadodara exotic stockist. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/titanium-pipe-weight-chart" />
      <Meta property="og:title" content="Titanium Pipe Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Titanium Grade 2 & 5 pipe weight chart per metre — ASTM B861. CMI Vadodara exotic stockist. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/titanium-pipe-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Titanium Pipe Weight Chart — Grade 2 & 5</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/titanium-pipe-weight-chart" />
      </main>
    </>
  );
}
