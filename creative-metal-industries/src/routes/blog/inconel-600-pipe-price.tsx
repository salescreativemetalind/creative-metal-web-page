/**
 * /blog/inconel-600-pipe-price
 * Target: "Inconel 600 pipe price per kg India"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Inconel 600 Pipe Price Per Kg India", "image": "https://www.creativemetalind.com/og-image.jpg",
...
export default function Inconel600PipePrice() {
  return (
    <>
      <Title>Inconel 600 Pipe Price India | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Inconel 600 pipe price per kg India — ASTM B167. July 2026 updated rates. CMI Vadodara stockist. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/inconel-600-pipe-price" />
      <Meta property="og:title" content="Inconel 600 Pipe Price India | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Inconel 600 pipe price per kg India — ASTM B167. July 2026 updated rates. CMI Vadodara stockist. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/inconel-600-pipe-price" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Inconel 600 Pipe Price Per Kg India</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <div style={{ background: "#f9fafb", border: "1px solid #e5e7eb", "border-radius": "10px", padding: "1.5rem", "margin-bottom": "2rem" }}>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What is the current Inconel 600 pipe price per kg rate?</h3>
        ...
        <RelatedPages currentPath="/blog/inconel-600-pipe-price" />
      </main>
    </>
  );
}
