...
export default function PipeFittingsSelectionGuide() {
  return (
    <>
      ...
      <Meta name="description" content="How to select pipe fittings for process piping — buttweld vs forged vs threaded, pressure class selection, ASME B16.9 vs B16.11 and material choice." />
