/**
 * /blog/super-duplex-2507-pipe-price
 * Target: "Super Duplex 2507 pipe price India"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Super Duplex 2507 Pipe Price in India", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/super-duplex-2507-pipe-price",
  "description": "Super Duplex 2507 pipe price per kg India. UNS S32750. July 2026 updated. CMI Vadodara supplier. Call +91 99982 80619."
});

const FAQ_SCHEMA = JSON.stringify({
  "@context": "https://schema.org", "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "What is the current Super Duplex 2507 pipe price rate?", "acceptedAnswer": { "@type": "Answer", "text": "The current rate varies based on grade, size, quantity, and market conditions (LME nickel, import duty, demand). Creative Metal Industries provides real-time pricing — call +91 99982 80619 for today's rate with quantity discounts. We offer 3-7 day price validity on formal quotations." } },
...
export default function SuperDuplex2507PipePrice() {
  return (
    <>
      <Title>Super Duplex 2507 Pipe Price India | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Super Duplex 2507 pipe price per kg India. UNS S32750. July 2026 updated. CMI Vadodara supplier. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/super-duplex-2507-pipe-price" />
      <Meta property="og:title" content="Super Duplex 2507 Pipe Price India | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Super Duplex 2507 pipe price per kg India. UNS S32750. July 2026 updated. CMI Vadodara supplier. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/super-duplex-2507-pipe-price" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Super Duplex 2507 Pipe Price in India</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <div style={{ background: "#f9fafb", border: "1px solid #e5e7eb", "border-radius": "10px", padding: "1.5rem", "margin-bottom": "2rem" }}>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What is the current Super Duplex 2507 pipe price rate?</h3>
        ...
        <RelatedPages currentPath="/blog/super-duplex-2507-pipe-price" />
      </main>
    </>
  );
}
