/**
 * /blog/asme-b16-47-large-flanges
 * Target: "ASME B16.47 large diameter flanges 26 to 60"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "url": "https://www.creativemetalind.com/blog/asme-b16-47-large-flanges",
  "description": "ASME B16.47 large diameter flanges 26 to 60. Expert guide by Creative Metal Industries Vadodara. Call +91 99982 80619 for enquiry."
});
...
export default function AsmeB1647LargeFlanges() {
  return (
    <>
      <Title>ASME B16.47 Large Flanges — 26" to 60" Dimensions | CMI I...</Title>
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>ASME B16.47 Large Flanges — 26" to 60" Dimensions</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/asme-b16-47-large-flanges" />
      </main>
    </>
  );
}
