/**
 * /blog/steel-weight-calculator
 * Target: "steel weight calculator all shapes online"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Steel Weight Calculator — All Shapes Online", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/steel-weight-calculator",
  "description": "Free steel weight calculator — pipe, plate, bar, angle, channel. All shapes. By CMI Vadodara Gujarat. Call +91 99982 80619."
});
...
export default function SteelWeightCalculator() {
  return (
    <>
      <Title>Steel Weight Calculator Online | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Free steel weight calculator — pipe, plate, bar, angle, channel. All shapes. By CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/steel-weight-calculator" />
      <Meta property="og:title" content="Steel Weight Calculator Online | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Free steel weight calculator — pipe, plate, bar, angle, channel. All shapes. By CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/steel-weight-calculator" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Steel Weight Calculator — All Shapes Online</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/steel-weight-calculator" />
      </main>
    </>
  );
}
