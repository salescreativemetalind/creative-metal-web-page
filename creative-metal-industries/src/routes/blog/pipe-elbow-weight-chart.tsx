/**
 * /blog/pipe-elbow-weight-chart
 * Target: "pipe elbow weight chart 90 45 degree all sizes"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Pipe Elbow Weight Chart — 90° & 45° All Sizes", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/pipe-elbow-weight-chart",
  "description": "Pipe elbow weight chart — 90° & 45° LR/SR, all sizes. ASME B16.9. Free chart CMI Vadodara. Call +91 99982 80619."
});
...
export default function PipeElbowWeightChart() {
  return (
    <>
      <Title>Pipe Elbow Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Pipe elbow weight chart — 90° & 45° LR/SR, all sizes. ASME B16.9. Free chart CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/pipe-elbow-weight-chart" />
      <Meta property="og:title" content="Pipe Elbow Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Pipe elbow weight chart — 90° & 45° LR/SR, all sizes. ASME B16.9. Free chart CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/pipe-elbow-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Pipe Elbow Weight Chart — 90° & 45° All Sizes</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/pipe-elbow-weight-chart" />
      </main>
    </>
  );
}
