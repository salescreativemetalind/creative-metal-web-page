/**
 * /blog/tmt-bar-price-today-gujarat
 * Target: "TMT bar price today Gujarat Fe 500D"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "url": "https://www.creativemetalind.com/blog/tmt-bar-price-today-gujarat",
  "description": "TMT bar price today Gujarat Fe 500D — 8mm to 32mm. SAIL, JSW, Tata. July 2026. CMI Vadodara. Call +91 99982 80619."
});

const FAQ_SCHEMA = JSON.stringify({
  "@context": "https://schema.org", "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "What is the current TMT bar price today Gujarat Fe 500D rate?", "acceptedAnswer": { "@type": "Answer", "text": "The current rate varies based on grade, size, quantity, and market conditions (LME nickel, import duty, demand). Creative Metal Industries provides real-time pricing — call +91 99982 80619 for today's rate with quantity discounts. We offer 3-7 day price validity on formal quotations." } },
...
export default function TmtBarPriceTodayGujarat() {
  return (
    <>
      <Title>TMT Bar Price Today Gujarat | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="TMT bar price today Gujarat Fe 500D — 8mm to 32mm. SAIL, JSW, Tata. July 2026. CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/tmt-bar-price-today-gujarat" />
      <Meta property="og:title" content="TMT Bar Price Today Gujarat | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="TMT bar price today Gujarat Fe 500D — 8mm to 32mm. SAIL, JSW, Tata. July 2026. CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/tmt-bar-price-today-gujarat" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>TMT Bar Price Today Gujarat — Fe 500D</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <div style={{ background: "#f9fafb", border: "1px solid #e5e7eb", "border-radius": "10px", padding: "1.5rem", "margin-bottom": "2rem" }}>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What is the current TMT bar price today Gujarat Fe 500D rate?</h3>
        ...
        <RelatedPages currentPath="/blog/tmt-bar-price-today-gujarat" />
      </main>
    </>
  );
}
