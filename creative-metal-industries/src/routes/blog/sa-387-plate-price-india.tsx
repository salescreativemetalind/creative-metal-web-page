/**
 * /blog/sa-387-plate-price-india
 * Target: "SA 387 alloy plate price per kg India"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "SA 387 Alloy Steel Plate Price Per Kg India", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/sa-387-plate-price-india",
  "description": "SA 387 Gr.11/22/91 alloy plate price per kg India. CR & NACE. July 2026. CMI Vadodara. Call +91 99982 80619."
});

const FAQ_SCHEMA = JSON.stringify({
  "@context": "https://schema.org", "@type": "FAQPage",
  "mainEntity": [
    { "@type": "Question", "name": "What is the current SA 387 alloy plate price per kg rate?", "acceptedAnswer": { "@type": "Answer", "text": "The current rate varies based on grade, size, quantity, and market conditions (LME nickel, import duty, demand). Creative Metal Industries provides real-time pricing — call +91 99982 80619 for today's rate with quantity discounts. We offer 3-7 day price validity on formal quotations." } },
...
export default function Sa387PlatePriceIndia() {
  return (
    <>
      <Title>SA 387 Plate Price India | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="SA 387 Gr.11/22/91 alloy plate price per kg India. CR & NACE. July 2026. CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/sa-387-plate-price-india" />
      <Meta property="og:title" content="SA 387 Plate Price India | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="SA 387 Gr.11/22/91 alloy plate price per kg India. CR & NACE. July 2026. CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/sa-387-plate-price-india" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>SA 387 Alloy Steel Plate Price Per Kg India</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <div style={{ background: "#f9fafb", border: "1px solid #e5e7eb", "border-radius": "10px", padding: "1.5rem", "margin-bottom": "2rem" }}>
          <h3 style={{ "font-size": "1rem", "font-weight": "700", color: "#111827", margin: "0 0 0.5rem" }}>What is the current SA 387 alloy plate price per kg rate?</h3>
        ...
        <RelatedPages currentPath="/blog/sa-387-plate-price-india" />
      </main>
    </>
  );
}
