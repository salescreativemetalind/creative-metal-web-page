/**
 * /blog/ss-round-bar-weight-chart
 * Target: "SS round bar weight per metre 304 316"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "SS Round Bar Weight Per Metre — 304/316", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ss-round-bar-weight-chart",
  "description": "SS round bar weight per metre chart — 304/316L, 6mm to 300mm. Free reference by CMI Vadodara. Call +91 99982 80619."
});
...
export default function SSRoundBarWeightChart() {
  return (
    <>
      <Title>SS Round Bar Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="SS round bar weight per metre chart — 304/316L, 6mm to 300mm. Free reference by CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ss-round-bar-weight-chart" />
      <Meta property="og:title" content="SS Round Bar Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="SS round bar weight per metre chart — 304/316L, 6mm to 300mm. Free reference by CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ss-round-bar-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>SS Round Bar Weight Per Metre — 304/316</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ss-round-bar-weight-chart" />
      </main>
    </>
  );
}
