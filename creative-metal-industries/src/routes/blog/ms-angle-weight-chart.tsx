/**
 * /blog/ms-angle-weight-chart
 * Target: "MS angle weight chart IS 808 all sizes"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "MS Angle Weight Chart — IS 808 All Sizes", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ms-angle-weight-chart",
  "description": "MS angle weight chart IS 808 — 20x20 to 200x200, per metre kg. Free reference. CMI Vadodara Gujarat. Call +91 99982 80619."
});
...
export default function MSAngleWeightChart() {
  return (
    <>
      <Title>MS Angle Weight Chart IS 808 | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="MS angle weight chart IS 808 — 20x20 to 200x200, per metre kg. Free reference. CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ms-angle-weight-chart" />
      <Meta property="og:title" content="MS Angle Weight Chart IS 808 | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="MS angle weight chart IS 808 — 20x20 to 200x200, per metre kg. Free reference. CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ms-angle-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>MS Angle Weight Chart — IS 808 All Sizes</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ms-angle-weight-chart" />
      </main>
    </>
  );
}
