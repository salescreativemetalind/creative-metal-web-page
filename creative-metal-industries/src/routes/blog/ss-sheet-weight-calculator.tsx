/**
 * /blog/ss-sheet-weight-calculator
 * Target: "SS sheet weight calculator 304 316 per piece"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "SS Sheet Weight Calculator — 304/316 Per Piece", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ss-sheet-weight-calculator",
  "description": "SS sheet weight calculator 304/316 per piece — all gauges. Free online tool by CMI Vadodara. Call +91 99982 80619."
});
...
export default function SSSheetWeightCalculator() {
  return (
    <>
      <Title>SS Sheet Weight Calculator | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="SS sheet weight calculator 304/316 per piece — all gauges. Free online tool by CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ss-sheet-weight-calculator" />
      <Meta property="og:title" content="SS Sheet Weight Calculator | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="SS sheet weight calculator 304/316 per piece — all gauges. Free online tool by CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ss-sheet-weight-calculator" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>SS Sheet Weight Calculator — 304/316 Per Piece</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ss-sheet-weight-calculator" />
      </main>
    </>
  );
}
