/**
 * /blog/ms-flat-bar-weight-chart
 * Target: "MS flat bar weight chart all sizes"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "MS Flat Bar Weight Chart — All Sizes", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ms-flat-bar-weight-chart",
  "description": "MS flat bar weight chart — all sizes 20x3 to 300x50mm, per metre kg. IS 2062. CMI Vadodara. Call +91 99982 80619."
});
...
export default function MSFlatBarWeightChart() {
  return (
    <>
      <Title>MS Flat Bar Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="MS flat bar weight chart — all sizes 20x3 to 300x50mm, per metre kg. IS 2062. CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ms-flat-bar-weight-chart" />
      <Meta property="og:title" content="MS Flat Bar Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="MS flat bar weight chart — all sizes 20x3 to 300x50mm, per metre kg. IS 2062. CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ms-flat-bar-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>MS Flat Bar Weight Chart — All Sizes</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ms-flat-bar-weight-chart" />
      </main>
    </>
  );
}
