/**
 * /blog/flange-bolt-chart
 * Target: "flange bolt chart ASME B16.5 size length"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Flange Bolt Chart — ASME B16.5 Size & Length", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/flange-bolt-chart",
  "description": "flange bolt chart ASME B16.5 size length. Expert guide by Creative Metal Industries Vadodara. Call +91 99982 80619 for enquiry."
});
...
export default function FlangeBoltChart() {
  return (
    <>
      <Title>Flange Bolt Chart — ASME B16.5 Size & Length | CMI India</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="flange bolt chart ASME B16.5 size length. Expert guide by Creative Metal Industries Vadodara. Call +91 99982 80619 for enquiry." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/flange-bolt-chart" />
      <Meta property="og:title" content="Flange Bolt Chart — ASME B16.5 Size & Length | CMI India" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="flange bolt chart ASME B16.5 size length. Expert guide by Creative Metal Industries Vadodara. Call +91 99982 80619 for enquiry." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/flange-bolt-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Flange Bolt Chart — ASME B16.5 Size & Length</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        <div style={{ "margin-bottom": "2.5rem" }}>
          ...
          <h1 style={{ "font-size": "clamp(1.8rem,4vw,2.5rem)", "font-weight": "800", color: "#111827", margin: "1rem 0 1.25rem", "line-height": "1.2" }}>
            Flange Bolt Chart — ASME B16.5 Size & Length
          </h1>
          <p style={{ "font-size": "1.05rem", color: "#374151", "line-height": "1.8" }}>
            This <strong>flange bolt chart — asme b16.5 size & length</strong> provides engineers, procurement teams, and fabricators with accurate dimensional reference data. Bookmark this page for quick access during material take-offs, inspection verification, and project estimation. All dimensions conform to the applicable ASTM, ASME, IS, or DIN standards. Creative Metal Industries, Vadodara stocks material across the full size range — call <strong>+91 99982 80619</strong> for specific size availability and pricing.
          </p>
        </div>
        ...
        <RelatedPages currentPath="/blog/flange-bolt-chart" />
      </main>
    </>
  );
}
