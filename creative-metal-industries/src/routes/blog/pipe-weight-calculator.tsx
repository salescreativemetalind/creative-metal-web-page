/**
 * /blog/pipe-weight-calculator
 * Target: "pipe weight calculator online SS CS alloy"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Pipe Weight Calculator Online — SS, CS & Alloy", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/pipe-weight-calculator",
  "description": "Free pipe weight calculator — SS, CS, alloy steel. Calculate per metre/foot. Formula + chart. By CMI Vadodara. Call +91 99982 80619."
});
...
export default function PipeWeightCalculator() {
  return (
    <>
      <Title>Pipe Weight Calculator Online | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Free pipe weight calculator — SS, CS, alloy steel. Calculate per metre/foot. Formula + chart. By CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/pipe-weight-calculator" />
      <Meta property="og:title" content="Pipe Weight Calculator Online | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Free pipe weight calculator — SS, CS, alloy steel. Calculate per metre/foot. Formula + chart. By CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/pipe-weight-calculator" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Pipe Weight Calculator Online — SS, CS & Alloy</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/pipe-weight-calculator" />
      </main>
    </>
  );
}
