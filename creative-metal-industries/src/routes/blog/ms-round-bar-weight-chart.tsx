/**
 * /blog/ms-round-bar-weight-chart
 * Target: "MS round bar weight per metre chart"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "MS Round Bar Weight Per Metre Chart", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ms-round-bar-weight-chart",
  "description": "MS round bar weight per metre chart — 6mm to 300mm diameter. IS 2062. Free reference CMI Vadodara. Call +91 99982 80619."
});
...
export default function MSRoundBarWeightChart() {
  return (
    <>
      <Title>MS Round Bar Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="MS round bar weight per metre chart — 6mm to 300mm diameter. IS 2062. Free reference CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ms-round-bar-weight-chart" />
      <Meta property="og:title" content="MS Round Bar Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="MS round bar weight per metre chart — 6mm to 300mm diameter. IS 2062. Free reference CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ms-round-bar-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>MS Round Bar Weight Per Metre Chart</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ms-round-bar-weight-chart" />
      </main>
    </>
  );
}
