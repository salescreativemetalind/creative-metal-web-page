/**
 * /blog/pipe-volume-calculator
 * Target: "pipe volume calculator litres per metre"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Pipe Volume Calculator — Litres Per Metre", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/pipe-volume-calculator",
  "description": "Pipe volume calculator — litres per metre for all pipe sizes. Free online tool by CMI Vadodara. Call +91 99982 80619."
});
...
export default function PipeVolumeCalculator() {
  return (
    <>
      <Title>Pipe Volume Calculator | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Pipe volume calculator — litres per metre for all pipe sizes. Free online tool by CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/pipe-volume-calculator" />
      <Meta property="og:title" content="Pipe Volume Calculator | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Pipe volume calculator — litres per metre for all pipe sizes. Free online tool by CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/pipe-volume-calculator" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Pipe Volume Calculator — Litres Per Metre</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/pipe-volume-calculator" />
      </main>
    </>
  );
}
