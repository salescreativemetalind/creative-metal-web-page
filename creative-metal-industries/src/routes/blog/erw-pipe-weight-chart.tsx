/**
 * /blog/erw-pipe-weight-chart
 * Target: "ERW pipe weight chart IS 1239 all classes"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "ERW Pipe Weight Chart — IS 1239 All Classes", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/erw-pipe-weight-chart",
  "description": "ERW pipe weight chart IS 1239 — Light, Medium, Heavy class per metre. Free chart by CMI Vadodara. Call +91 99982 80619."
});
...
export default function ErwPipeWeightChart() {
  return (
    <>
      <Title>ERW Pipe Weight Chart IS 1239 | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="ERW pipe weight chart IS 1239 — Light, Medium, Heavy class per metre. Free chart by CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/erw-pipe-weight-chart" />
      <Meta property="og:title" content="ERW Pipe Weight Chart IS 1239 | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="ERW pipe weight chart IS 1239 — Light, Medium, Heavy class per metre. Free chart by CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/erw-pipe-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>ERW Pipe Weight Chart — IS 1239 All Classes</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/erw-pipe-weight-chart" />
      </main>
    </>
  );
}
