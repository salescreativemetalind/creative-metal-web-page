/**
 * /blog/ss-angle-weight-chart
 * Target: "SS angle weight chart stainless steel"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "SS Angle Weight Chart — Stainless Steel", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ss-angle-weight-chart",
  "description": "Stainless steel angle weight chart — 304/316L all sizes per metre. Free reference CMI Vadodara. Call +91 99982 80619."
});
...
export default function SSAngleWeightChart() {
  return (
    <>
      <Title>SS Angle Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Stainless steel angle weight chart — 304/316L all sizes per metre. Free reference CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ss-angle-weight-chart" />
      <Meta property="og:title" content="SS Angle Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Stainless steel angle weight chart — 304/316L all sizes per metre. Free reference CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ss-angle-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>SS Angle Weight Chart — Stainless Steel</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ss-angle-weight-chart" />
      </main>
    </>
  );
}
