/**
 * /blog/inconel-pipe-weight-chart
 * Target: "Inconel 625 600 pipe weight per metre"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Inconel 625/600 Pipe Weight Per Metre Chart", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/inconel-pipe-weight-chart",
  "description": "Inconel 625 & 600 pipe weight per metre chart — all schedules. ASTM B444/B167. CMI Vadodara. Call +91 99982 80619."
});
...
export default function InconelPipeWeightChart() {
  return (
    <>
      <Title>Inconel Pipe Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Inconel 625 & 600 pipe weight per metre chart — all schedules. ASTM B444/B167. CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/inconel-pipe-weight-chart" />
      <Meta property="og:title" content="Inconel Pipe Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Inconel 625 & 600 pipe weight per metre chart — all schedules. ASTM B444/B167. CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/inconel-pipe-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Inconel 625/600 Pipe Weight Per Metre Chart</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/inconel-pipe-weight-chart" />
      </main>
    </>
  );
}
