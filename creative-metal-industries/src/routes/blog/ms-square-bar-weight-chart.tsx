/**
 * /blog/ms-square-bar-weight-chart
 * Target: "MS square bar weight chart all sizes"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "MS Square Bar Weight Chart — All Sizes", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ms-square-bar-weight-chart",
  "description": "MS square bar weight chart — 8mm to 150mm, per metre. IS 2062. CMI Vadodara Gujarat stockist. Call +91 99982 80619."
});
...
export default function MSSquareBarWeightChart() {
  return (
    <>
      <Title>MS Square Bar Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="MS square bar weight chart — 8mm to 150mm, per metre. IS 2062. CMI Vadodara Gujarat stockist. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ms-square-bar-weight-chart" />
      <Meta property="og:title" content="MS Square Bar Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="MS square bar weight chart — 8mm to 150mm, per metre. IS 2062. CMI Vadodara Gujarat stockist. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ms-square-bar-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>MS Square Bar Weight Chart — All Sizes</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ms-square-bar-weight-chart" />
      </main>
    </>
  );
}
