/**
 * /blog/copper-nickel-pipe-weight
 * Target: "copper nickel pipe weight chart per metre"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Copper Nickel Pipe Weight Chart Per Metre", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/copper-nickel-pipe-weight",
  "description": "Copper nickel 70/30 90/10 pipe weight chart per metre — ASTM B466. CMI Vadodara exotic alloy. Call +91 99982 80619."
});
...
export default function CopperNickelPipeWeight() {
  return (
    <>
      <Title>CuNi Pipe Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Copper nickel 70/30 90/10 pipe weight chart per metre — ASTM B466. CMI Vadodara exotic alloy. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/copper-nickel-pipe-weight" />
      <Meta property="og:title" content="CuNi Pipe Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Copper nickel 70/30 90/10 pipe weight chart per metre — ASTM B466. CMI Vadodara exotic alloy. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/copper-nickel-pipe-weight" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Copper Nickel Pipe Weight Chart Per Metre</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/copper-nickel-pipe-weight" />
      </main>
    </>
  );
}
