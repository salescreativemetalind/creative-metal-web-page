/**
 * /blog/ismc-channel-weight-chart
 * Target: "ISMC channel weight chart IS 808"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "ISMC Channel Weight Chart — IS 808", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/ismc-channel-weight-chart",
  "description": "ISMC channel weight chart IS 808 — ISMC 75 to 400, kg per metre. Free download. CMI Vadodara. Call +91 99982 80619."
});
...
export default function IsmcChannelWeightChart() {
  return (
    <>
      <Title>ISMC Channel Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="ISMC channel weight chart IS 808 — ISMC 75 to 400, kg per metre. Free download. CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/ismc-channel-weight-chart" />
      <Meta property="og:title" content="ISMC Channel Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="ISMC channel weight chart IS 808 — ISMC 75 to 400, kg per metre. Free download. CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/ismc-channel-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>ISMC Channel Weight Chart — IS 808</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/ismc-channel-weight-chart" />
      </main>
    </>
  );
}
