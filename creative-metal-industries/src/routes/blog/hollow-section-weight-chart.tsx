/**
 * /blog/hollow-section-weight-chart
 * Target: "hollow section weight chart RHS SHS CHS"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Hollow Section Weight Chart — RHS, SHS & CHS", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/hollow-section-weight-chart",
  "description": "Hollow section weight chart — RHS, SHS, CHS per metre. All sizes. MS & SS. CMI Vadodara Gujarat. Call +91 99982 80619."
});
...
export default function HollowSectionWeightChart() {
  return (
    <>
      <Title>Hollow Section Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Hollow section weight chart — RHS, SHS, CHS per metre. All sizes. MS & SS. CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/hollow-section-weight-chart" />
      <Meta property="og:title" content="Hollow Section Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Hollow section weight chart — RHS, SHS, CHS per metre. All sizes. MS & SS. CMI Vadodara Gujarat. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/hollow-section-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Hollow Section Weight Chart — RHS, SHS & CHS</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/hollow-section-weight-chart" />
      </main>
    </>
  );
}
