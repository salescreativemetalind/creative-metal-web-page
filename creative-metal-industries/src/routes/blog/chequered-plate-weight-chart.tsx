/**
 * /blog/chequered-plate-weight-chart
 * Target: "chequered plate weight chart 3mm to 8mm"
 */
...
const SCHEMA = JSON.stringify({
  ...
  "@type": "Article",
  "headline": "Chequered Plate Weight Chart — 3mm to 8mm", "image": "https://www.creativemetalind.com/og-image.jpg",
  ...
  "url": "https://www.creativemetalind.com/blog/chequered-plate-weight-chart",
  "description": "Chequered plate weight chart 3mm to 8mm — MS & SS. Per sheet weight. Free chart CMI Vadodara. Call +91 99982 80619."
});
...
export default function ChequeredPlateWeightChart() {
  return (
    <>
      <Title>Chequered Plate Weight Chart | CMI</Title>
      <Meta name="robots" content="index, follow, max-image-preview:large" />
      <Meta name="description" content="Chequered plate weight chart 3mm to 8mm — MS & SS. Per sheet weight. Free chart CMI Vadodara. Call +91 99982 80619." />
      <Link rel="canonical" href="https://www.creativemetalind.com/blog/chequered-plate-weight-chart" />
      <Meta property="og:title" content="Chequered Plate Weight Chart | CMI" />
      <Meta property="og:type" content="article" />
      <Meta property="og:description" content="Chequered plate weight chart 3mm to 8mm — MS & SS. Per sheet weight. Free chart CMI Vadodara. Call +91 99982 80619." />
      <Meta property="og:url" content="https://www.creativemetalind.com/blog/chequered-plate-weight-chart" />
      ...
      <div style={{ background: "#f9fafb", "border-bottom": "1px solid #e5e7eb", padding: "0.6rem 1.5rem", "font-size": "0.82rem", color: "#6b7280" }}>
        ...
        <span style={{ margin: "0 0.5rem" }}>›</span>
        <span>Chequered Plate Weight Chart — 3mm to 8mm</span>
      </div>
      ...
      <main style={{ "max-width": "800px", margin: "0 auto", padding: "3rem 1.5rem" }}>
        ...
        <RelatedPages currentPath="/blog/chequered-plate-weight-chart" />
      </main>
    </>
  );
}
