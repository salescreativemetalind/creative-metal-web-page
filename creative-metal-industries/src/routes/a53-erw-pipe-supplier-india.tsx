...
export default function A53ErwPipeSupplierIndia() {
  return (
    <>
      ...
      <Meta name="description" content="A53 ERW pipe supplier India — ASTM A53 Type E Grade B for structural, water and fire protection. Sizes 1/2 inch to 26 inch, SCH 40. Black & galvanised." />
