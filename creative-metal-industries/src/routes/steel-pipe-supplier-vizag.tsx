...
const SCHEMA = JSON.stringify({"@context":"https://schema.org","@graph":[{"@type":"LocalBusiness","@id":"https://www.creativemetalind.com/steel-pipe-supplier-vizag#business","parentOrganization":{"@id":"https://www.creativemetalind.com/#organization"},"name":"Creative Metal Industries — Pipe Supplier Vizag","description":"Leading pipe supplier in Visakhapatnam offering SS pipes, CS pipes, alloy steel, duplex, exotic alloys for HPCL refinery, Vizag Steel Plant and shipbuilding.","telephone":"+919998280619","url":"https://www.creativemetalind.com/steel-pipe-supplier-vizag","address":{"@type":"PostalAddress","streetAddress":"386/B GIDC Estate, Makarpura","addressLocality":"Vadodara","addressRegion":"Gujarat","postalCode":"390010","addressCountry":"IN"},"areaServed":{"@type":"City","name":"Visakhapatnam","containedInPlace":{"@type":"State","name":"Andhra Pradesh"}},"priceRange":"$$"},{"@type":"BreadcrumbList","itemListElement":[{"@type":"ListItem","position":1,"name":"Home","item":"https://www.creativemetalind.com"},{"@type":"ListItem","position":2,"name":"Pipe Supplier Vizag","item":"https://www.creativemetalind.com/steel-pipe-supplier-vizag"}]}]});
  ...
  return (
    <>
      ...
      <main style={{"max-width":"960px",margin:"0 auto",padding:"3rem 1.5rem"}}>
        ...
        <LocationContent slug="vizag" />
      
        <RelatedPages currentPath="/steel-pipe-supplier-vizag" />
      </main>
