# URLs to Re-Index in Google Search Console

All live pages on the site (48 URLs), grouped so you can submit the most
important ones first. These are the current, updated pages after the
182-keyword focus work.

## How to use this file
1. Go to https://search.google.com/search-console (property: creativemetalind.com)
2. Paste one URL into the "Inspect any URL" bar at the top, press Enter
3. Click **Request Indexing**
4. Repeat for the next URL

**Note:** Google allows only ~10-12 manual "Request Indexing" per day per
property, and only ONE URL at a time. So work through this list top-to-bottom
...
## DAY 3 — Titanium, alloy, carbon & A36
...
## DAY 4 — Remaining stainless steel grade pages
...
## IMPORTANT: Submit the sitemap (do this once, on Day 1)

Instead of relying only on manual requests, submit your sitemap so Google
...
## Pages that were REMOVED (do NOT request indexing for these)

These 6 pages were deleted. Do not submit them. Google will drop them from
the index automatically once it re-crawls and gets a 404:

- https://www.creativemetalind.com/p5-alloy-steel-pipe-supplier
- https://www.creativemetalind.com/p9-alloy-steel-pipe-supplier
- https://www.creativemetalind.com/p92-alloy-steel-pipe-supplier
- https://www.creativemetalind.com/hastelloy-b2-pipe-supplier-india
- https://www.creativemetalind.com/metal-trading
- https://www.creativemetalind.com/stainless-steel-supplier-gujarat

(Optional: in GSC you can use **Removals** to temporarily hide these faster,
but it is not required — the 404 will handle it over time.)
